    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-slate-600 font-medium">Loading refunds...</div>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-slate-900">Refunds Management</h1>
                <p className="text-sm text-slate-600">Support dashboard</p>
              </div>
            </div>
                ...
                {filteredRefunds.map((refund) => (
                  <tr key={refund.id} className="border-b border-slate-100 hover:bg-slate-50">
                    <td className="py-4 px-4">
                      <div className="font-medium text-slate-900">{refund.customer_name}</div>
                    </td>
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-2">
                    ...
                    <td className="py-4 px-4 text-sm text-slate-600">{refund.reason_code}</td>
                    <td className="py-4 px-4 text-sm text-slate-600 font-mono">{refund.original_txn_id}</td>
                    <td className="py-4 px-4">
